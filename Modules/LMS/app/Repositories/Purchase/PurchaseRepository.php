...
use Modules\LMS\Repositories\Payment\PaymentRepository;
        ...
        foreach ($request->courses as $courseId) {
            if (! static::$model::where(['user_id' => $userId, 'course_id' => $courseId])->exists()) {
                ...
                if ($course) {
                    ...
                    PaymentRepository::purchaseDetails($purchaseDetail);
                }
                PaymentRepository::profitShareCalculate($course,  $discount_price);
            }
        }
