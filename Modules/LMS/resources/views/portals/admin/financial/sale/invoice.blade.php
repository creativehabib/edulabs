            ...
            <table
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr class="last:border-b">
                        ...
                        <td class="px-2 py-7"> ${{ $invoice?->price }}</td>
                        <td class="px-2 py-7"> ${{ $invoice?->discount_price }}</td>
                        <td class="px-2 py-7">
            ...
            <table class="w-[400px]">
                <tbody>
                    ...
                    <tr class="last:border-t">
                        ...
                        <td class="px-5 py-4 w-10">
                            <div class="text-[#111827]/80 font-medium leading-none">${{ $invoice?->platform_fee }}
                            </div>
                        </td>
                    </tr>
                    <tr class="last:border-t">
                        ...
                        <td class="px-5 py-4 bg-[#111827]/5 w-10">
                            <div class="text-[#111827]/80 font-bold leading-none">
                                ${{ $subTotal + $invoice?->platform_fee }}</div>
                        </td>
                    </tr>
                </tbody>
            </table>
