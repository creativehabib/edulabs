<x-dashboard-layout>
    ...
    <div class="flex flex-col lg:flex-row gap-x-4">
        ...
        <div class="grow">
                ...
                <form enctype="multipart/form-data" class="add_setting" method="POST"
                    ...
                    <div class="mt-7">
                        <div class="leading-none">
                            <label class="form-label"> {{ translate('Platform free') }} ($)</label>
            ...
            <div id="openai-setting" class="tabcontent card hidden">
                <h6 class="leading-none text-xl font-semibold text-heading">
                    {{ translate('Open ai setting') }}
                </h6>
                <form enctype="multipart/form-data" class="add_setting" method="POST"
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-6 mt-7">
                        <div class="col-span-full xl:col-auto leading-none">
                            <label class="form-label">{{ translate('Open Ai Modal') }}</label>
                            <select name="ai_modal" class="form-input dark:bg-dark-card-two">
                                <option>{{ translate('Select ai model') }}</option>
                                <option value="gpt-4o"
