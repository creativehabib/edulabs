                ...
                <table
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
                        @foreach ($bundles as $bundle)
                            @php $translations = parse_translation($bundle); @endphp
                            @php
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h6 class="text-heading dark:text-white font-bold line-clamp-1"> <a
                                                    href="#">{{ $translations['title'] ?? $bundle->title ?? '' }}</a> </h6>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-4">${{ number_format($bundle->price, 2) }}</td>
...
@else
    <x-portal::admin.empty-card title="No bundle" action="{{ route('bundle.create') }}"
        btnText="Add New" />
    @endif
</x-dashboard-layout>
