                        ...
                        @foreach ($payments as $payment)
                            <tr>
                                <td class="px-3.5 py-4">
                                    @if (fileExists('lms/payments', $payment?->logo) == true && $payment?->logo != null)
                                        <div
                                            class="max-w-[100px] h-auto rounded-md overflow-hidden dk-theme-card-square">
                                            <img src="{{ asset('storage/lms/payments/' . $payment?->logo) }}"
                                                alt="payment" class="max-w-[100px] max-h-10">
                                        </div>
                                    @else
                                        <div
                                            class="max-w-[100px] h-auto rounded-md overflow-hidden dk-theme-card-square">
                                            <img src="{{ asset('lms/assets/images/placeholder/thumbnail612.jpg') }}"
                                                alt="payment" class="max-w-[100px] max-h-10">
                                        </div>
                                    @endif
                                </td>
