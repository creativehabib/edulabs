    ...
    <div class="bg-primary-50 p-6 rounded-xl">
        <form class="get-form" method="get" action="{{ route('apply.coupon') }}">
            ...
            <div class="flex mt-4">
                ...
                <button type="submit" class="btn b-solid btn-primary-solid rounded-l-none rtl:rounded-l-full rounded-r-full rtl:rounded-r-none">
                    {{ translate('Apply') }}
                </button>
            </div>
        </form>
                ...
                <tr id="discount-area">
                    @if ($data['discountAmount'])
                        ...
                        <td class="px-1 py-4 text-right rtl:text-left" id="discount-area">
                            <div class="text-heading/70 font-semibold leading-none">${{ $data['discountAmount'] }}</div>
                        </td>
                    @endif
                </tr>
                <tr>
