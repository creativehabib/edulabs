$(function () {
    "use strict";
    $(".sniper-loader").hide(),
        $("#scheduleDate").flatpickr({ enableTime: !0, dateFormat: "Y-m-d" }),
    ...
    (e = e ? JSON.parse(e) : ""),
        ...
        $(document).on("click", ".add-faq", function () {
            let e = $(this)
                ...
                .data("length");
            e++,
                $(".faq-area").append(` <div class="flex gap-4">
...
`),
        ...
        $(document).on("click", ".add-outcomes", function () {
            let e = $(this)
                ...
                .data("length");
            e++,
                $(".outcomes-area").append(` <div class="flex gap-4">
...
`),
        ...
        $(document).on("click", ".delete-btn", function (e) {
            ...
            if ($(t).data("id")) {
                let a = $(t).data("id"),
                    i = $(t).data("key"),
                    n = baseUrl + "/course/delete-information";
                $.ajax({
                    url: n,
                    method: "GET",
                    data: { id: a, key: i },
                    dataType: "json",
                    success: function (e) {
                        "success" == e.status && $(t).parent().remove();
                    },
                    error: function (e) {
        ...
        $(document).on("click", ".add-requirement", function () {
            let e = $(this)
                ...
                .data("length");
            e++,
                $(".requirement-area").append(` <div class="flex gap-4">
    <div class="grow flex flex-col gap-2 relative">
...
`),
        ...
        $(".tag-list").select2({
            ...
            templateResult: function e(t) {
                ...
                var a = $(
                    "<div class='select2-result-repository clearfix'><div class='select2-result-repository__title'></div></div></div></div>"
                );
                return (
                    a.find(".select2-result-repository__title").text(t.name), a
                );
            },
            templateSelection: function e(t) {
                return t.name || t.text || t.id;
            },
        }),
        "" !== e &&
            $.each(e, function (e, t) {
                var a = new Option(t.name, t.id, !0, !0);
                setTimeout(() => {
                    $(
                    ...
                    $(".tag-list").append(a).trigger("change");
            }),
        new Sortable(chapterList, {
            ...
            onSort: function (e) {
                let t;
                i(
                    baseUrl + "/course/chapter-sorted",
                    $(e.from).find(".chapter-item")
                );
            },
        });
    let t = document.querySelectorAll(".topicList");
    function a(e, t, a = null) {
        $.ajax({
            ...
            success: function (e) {
                "success" == e.status &&
                    ($(t).html(e.data), $(".sniper-loader").hide());
            },
            error: function (e) {
                Command: toastr.error("Not Found");
            },
    ...
    $.each(t, function (e, t) {
        new Sortable(t, {
            ...
            onSort: function (e) {
                let t;
                i(
                    baseUrl + "/course/topic-sorted",
                    $(e.from).find(".topic-item")
                );
            },
        });
    }),
        ...
        $(document).on("click", ".edit-chapter", function () {
            ...
            $("#model-header").html(`${editChapter}`),
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        "success" == e.status &&
                            ($("#chapterId").val(`${e.data.id}`),
                            $("#chapterTitle").val(`${e.data.title}`));
                    },
                    error: function (e) {
                        Command: toastr.error("Not Found");
                    },
        ...
        $(document).on("change", ".topic-type-list", function (e) {
            let t = baseUrl + "/course/chapter-topic-type/" + $(this).val(),
                i = $(".courseId").val();
            a(t, $(".form-field-area"), {
                course_id: i,
                topic_id: "",
        ...
        $(document).on("click", ".topic-edit", function () {
            let e = $(this).data("topic-id"),
                t = $(this).data("topic-type"),
                i = $(this).data("chapter-id"),
                n = baseUrl + "/course/chapter-topic-type/" + t,
                l = $(".courseId").val();
        ...
        $(document).on("click", ".add-question", function () {
            let e = $(this).data("id");
            $("#quizId").val(e), $(".answer-list-area").html("");
        }),
        $(document).on("change", ".quiz-type-list", function () {
            let e = $(".answer-list-area").html(""),
                t = $(this).val();
            "multiple-choice" == t || "single-choice" == t
                ? $(e).html(`<div class="mt-10">
...
<div class="mt-10 mb-11">
    ...
    <input type="text" class="form-input choices-input" name=answers[]" >
                  ...
                  (function e() {
                      let t = document.querySelectorAll(".choices-input");
                      t.forEach((e) => {
                          new Choices(e, {
                              removeItemButton: !0,
                              maxItemCount: 3,
        ...
        $(document).on("click", ".addQuizAns", function () {
            let e = $(this).data("quiztype"),
                t = $(this).parent().find(".quiz-ans-container").data("length");
            t++,
...
<li class="border border-input-border rounded-lg p-2 removeable-parent">
    ...
    <div class="leading-none flex items-center gap-2 mt-2">
        <label for="correntans${t}" class="inline-flex items-center cursor-pointer">
            ${
                "multiple-choice" == e
                    ? `<input type="checkbox" id="correntans${t}" name="answers[${t}][correct]" class="appearance-none peer"> <div class="switcher switcher-primary-solid"></div>`
                    : `<input type="radio" id="correntans${t}" name="answers[${t}][correct]" class="radio radio-primary question-type-single">`
            }
        </label>
...
`),
                $(this).parent().find(".quiz-ans-container").data("length", t);
        }),
        ...
        $(document).on("click", ".view-question", function () {
            let e;
            a(
                baseUrl + "/quizzes/quiz-question/" + $(this).data("id"),
                $("#questionItem")
            );
        }),
 ...
 `)
                    : $("#courseVideoFile")
                          .html(`<label class="form-label">${uploadFileText}</label>
    ...
    `);
        ...
        $(document).on("click", ".question-type-single", function () {
            $(".question-type-single").not(this).prop("checked", !1),
                $(this).prop("checked", !0);
        }),
        $(document).on("change", ".course-price-cal", function () {
            ...
            a = parseInt(a, 10);
            let n = i + (t = Number(t));
            e.parent().parent().find("#total_price").val(n);
        }),
        $(document).on("input", ".percentage-calculate", function e() {
            let t = 0;
            $(".percentage-calculate").each(function () {
                let e = parseFloat($(this).val()) || 0;
                t += e;
            }),
                100 < t && alert("warning! You value is gether thant 100");
        });
});
